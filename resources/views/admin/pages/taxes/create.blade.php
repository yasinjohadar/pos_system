        ...
        <div class="container-fluid p-0">
            <div class="users-premium">
                ...
                <div class="users-header">
                    <h5 class="users-page-title">إضافة ضريبة</h5>
                ...
                <form action="{{ route('admin.taxes.store') }}" method="POST">
                    ...
                    <div class="users-form-layout">
                        @include('admin.components.premium.form-aside', [
                            'icon' => 'fa-percent',
                            'title' => 'ضريبة جديدة',
                            'text' => 'عرّف أنواع الضرائب المستخدمة في الفواتير والعروض.',
                            'tips' => ['النوع نسبة مئوية أو مبلغ ثابت', 'الضرائب غير النشطة لا تظهر في القوائم'],
                        ])
                            ...
                            <div class="users-form-card__body">
                                <div class="users-form-grid">
                                    <div class="users-form-group">
                                        ...
                                        <input type="text" name="name" id="name" class="users-form-input @error('name') is-invalid @enderror" value="{{ old('name') }}" required>
                                    ...
                                    <div class="users-form-group">
                                        ...
                                        <input type="number" name="rate" id="rate" step="0.0001" min="0" class="users-form-input @error('rate') is-invalid @enderror" value="{{ old('rate', 0) }}" required>
                                    ...
                                    <div class="users-form-group users-form-group--full">
                                        <label class="users-form-toggle">
                                            <input type="checkbox" name="is_active" value="1" class="users-form-toggle-input" {{ old('is_active', true) ? 'checked' : '' }}>
