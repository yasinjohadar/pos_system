...
<div class="main-content app-content">
    <div class="container-fluid">
        <div class="d-md-flex d-block align-items-center justify-content-between my-4 page-header-breadcrumb">
            <div class="my-auto">
                <h5 class="page-title fs-21 mb-1">الموردون</h5>
            </div>
            @can('supplier-create')
            <div>
                ...
                <div class="card shadow-sm border-0">
                    <div class="card-body">
                        <form method="GET" class="mb-4 row g-3">
                            <div class="col-md-4">
                                <input type="text" name="query" class="form-control" placeholder="بحث (الاسم، الهاتف، البريد)" value="{{ request('query') }}">
                            </div>
                            <div class="col-md-3">
                        ...
                        <div class="table-responsive">
                            <table class="table table-striped table-bordered text-center mb-0">
                                ...
                                <tbody>
                                        ...
                                        <tr>
                                            ...
                                            <td>
                                                <div class="d-flex gap-2 justify-content-center flex-wrap">
                                                    @can('supplier-show')
                                                    <a href="{{ route('admin.suppliers.show', $supplier) }}" class="btn btn-sm btn-info" title="عرض"><i class="fas fa-eye"></i></a>
                                                    @endcan
                                                    @can('supplier-edit')
                                                    <a href="{{ route('admin.suppliers.edit', $supplier) }}" class="btn btn-sm btn-primary" title="تعديل"><i class="fas fa-edit"></i></a>
                                                    @endcan
                                                    @can('supplier-delete')
                                    ...
                                    @empty
                                        <tr>
                                            <td colspan="6" class="text-center">لا يوجد موردون.</td>
                                        </tr>
                                    @endforelse
                                </tbody>
                            </table>
