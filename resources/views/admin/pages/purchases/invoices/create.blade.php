        ...
        <div class="container-fluid p-0">
            <div class="users-premium">
                ...
                <div class="users-header">
                    <h5 class="users-page-title">فاتورة شراء جديدة</h5>
                ...
                @include('admin.pages.purchases.invoices.partials.form', [
                    'action' => route('admin.purchase-invoices.store'),
                    'cancelUrl' => route('admin.purchase-invoices.index'),
                    'oldProducts' => $oldProducts,
                    'selectedSupplier' => $selectedSupplier ?? null,
                    'submitLabel' => 'حفظ الفاتورة (مسودة)',
                ])
