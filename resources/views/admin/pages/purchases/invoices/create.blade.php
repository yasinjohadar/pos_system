...
<div class="main-content app-content">
    <div class="container-fluid">
        <div class="d-md-flex d-block align-items-center justify-content-between my-4 page-header-breadcrumb">
            <div class="my-auto">
                <h5 class="page-title fs-21 mb-1">فاتورة شراء جديدة</h5>
            </div>
            <div>
                <a href="{{ route('admin.purchase-invoices.index') }}" class="btn btn-secondary btn-sm">
        ...
        <form action="{{ route('admin.purchase-invoices.store') }}" method="POST" id="invoice-form">
            @csrf
            <div class="row">
                <div class="col-lg-8">
                        ...
                        <div class="card-body">
                            <div class="row g-3">
                                ...
                                <div class="col-md-4">
                                    ...
                                    <select name="warehouse_id" id="warehouse_id" class="form-select" required>
                                        ...
                                        @foreach($warehouses as $w)
                                            <option value="{{ $w->id }}" {{ old('warehouse_id') == $w->id ? 'selected' : '' }}>{{ $w->name }} ({{ $w->branch->name ?? '' }})</option>
                                        @endforeach
                                    </select>
                                </div>
                                <div class="col-md-4">
                                ...
                                <div class="col-md-2">
                                    ...
                                    <input type="number" step="0.01" name="discount_value" class="form-control" value="{{ old('discount_value', 0) }}" min="0">
                                </div>
                                <div class="col-12">
                                ...
                                <table class="table table-bordered mb-0" id="items-table">
                                    <thead class="table-light">
                                        <tr>
                                            ...
                                            <th width="120">سعر الوحدة (تكلفة)</th>
            ...
            <div class="d-flex gap-2 mb-4">
                ...
                <a href="{{ route('admin.purchase-invoices.index') }}" class="btn btn-secondary">إلغاء</a>
            </div>
        </form>
    </div>
</div>
