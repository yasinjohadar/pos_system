...
<div class="main-content app-content">
    <div class="container-fluid">
        <div class="d-md-flex d-block align-items-center justify-content-between my-4 page-header-breadcrumb">
            <div class="my-auto">
                <h5 class="page-title fs-21 mb-1">إضافة خزنة / بنك</h5>
            </div>
            <div>
                        ...
                        <form action="{{ route('admin.treasuries.store') }}" method="POST">
                            ...
                            <div class="mb-3">
                                ...
                                <select name="type" id="type" class="form-select @error('type') is-invalid @enderror" required>
                                    <option value="cashbox" {{ old('type', 'cashbox') === 'cashbox' ? 'selected' : '' }}>خزنة</option>
                            ...
                            <div class="mb-3">
                                ...
                                <input type="text" class="form-control @error('currency') is-invalid @enderror" id="currency" name="currency" value="{{ old('currency') }}" placeholder="مثال: SAR">
