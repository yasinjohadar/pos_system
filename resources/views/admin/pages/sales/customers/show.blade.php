...
<div class="main-content app-content">
    <div class="container-fluid">
        <div class="d-md-flex d-block align-items-center justify-content-between my-4 page-header-breadcrumb">
            <div class="my-auto">
                <h5 class="page-title fs-21 mb-1">تفاصيل العميل: {{ $customer->name }}</h5>
            </div>
            <div class="d-flex gap-2">
                ...
                @endcan
                @can('customer-show')
                <a href="{{ route('admin.customers.statement', $customer) }}" class="btn btn-info btn-sm">
                    ...
                    <div class="card-body">
                        <table class="table table-borderless mb-0">
                            ...
                            <tr>
                                ...
                                <td>{{ number_format($customer->total_returns, 2) }}</td>
                            </tr>
                            <tr>
                            ...
                            <tr>
                                <td class="text-muted">الرصيد المستحق:</td>
            ...
            <div class="col-lg-7">
                <div class="card shadow-sm border-0">
                    <div class="card-header d-flex justify-content-between align-items-center">
                        <h6 class="mb-0">آخر الفواتير</h6>
                        <a href="{{ route('admin.sale-invoices.index', ['customer_id' => $customer->id]) }}" class="btn btn-sm btn-outline-primary">عرض الكل</a>
                    </div>
                    <div class="card-body">
                                ...
                                <tbody>
                                    @forelse($customer->saleInvoices as $inv)
                                        <tr>
                                            ...
                                            <td>
                                                <a href="{{ route('admin.sale-invoices.show', $inv) }}" class="btn btn-sm btn-info"><i class="fas fa-eye"></i></a>
                                            </td>
                                        </tr>
                                    @empty
                                        <tr>
                                            <td colspan="5" class="text-center">لا توجد فواتير لهذا العميل.</td>
                                        </tr>
                                    @endforelse
                                </tbody>
                            </table>
