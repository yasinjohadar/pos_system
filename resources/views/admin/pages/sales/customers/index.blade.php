                                        ...
                                        <tr>
                                            ...
                                            <td>
                                                <div class="d-flex gap-2 justify-content-center flex-wrap">
                                                    @can('customer-show')
                                                    <a href="{{ route('admin.customers.show', $customer) }}" class="btn btn-sm btn-info" title="عرض"><i class="fas fa-eye"></i></a>
                                                    @endcan
                                                    @can('customer-edit')
                                                    <a href="{{ route('admin.customers.edit', $customer) }}" class="btn btn-sm btn-primary" title="تعديل"><i class="fas fa-edit"></i></a>
                                                    @endcan
                                                    @can('customer-delete')
