        ...
        <div class="users-detail-card__body" style="padding: 1.25rem;">
            <div class="users-detail-item" style="margin: 0;">
                ...
                <div class="users-detail-item__content">
                    <span class="users-detail-item__label">عدد فواتير الشراء المؤكدة</span>
        ...
        <div class="users-detail-card__body" style="padding: 1.25rem;">
            <div class="users-detail-item" style="margin: 0;">
                ...
                <div class="users-detail-item__content">
                    ...
                    <div class="users-detail-item__value">
                        <span class="users-amount users-qty--out" style="font-size: 1.25rem; font-weight: 700;">{{ number_format($summary['total_purchases'], 2) }}</span>
                    </div>
                </div>
            </div>
        </div>
    ...
    <div class="users-detail-card">
        <div class="users-detail-card__body" style="padding: 1.25rem;">
            <div class="users-detail-item" style="margin: 0;">
                ...
                <div class="users-detail-item__content">
                    <span class="users-detail-item__label">صافي المشتريات</span>
                    <div class="users-detail-item__value">
                        <span class="users-amount" style="font-size: 1.25rem; font-weight: 700;">{{ number_format($summary['net_purchases'], 2) }}</span>
...
@else
    <div class="users-table-card" style="margin-top: 1.25rem;">
        <div class="users-empty" style="padding: 2.5rem 1rem;">
            لا توجد مشتريات مؤكدة في هذا التاريخ — جرّب تاريخاً آخر أو شغّل <code>PurchaseSeeder</code>
        </div>
    </div>
@endif
