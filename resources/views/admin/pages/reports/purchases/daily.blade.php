...
<div class="main-content app-content">
    <div class="container-fluid">
        <div class="d-md-flex d-block align-items-center justify-content-between my-4 page-header-breadcrumb">
            <div class="my-auto">
                <h5 class="page-title fs-21 mb-1">تقرير المشتريات اليومي</h5>
            </div>
        </div>
        ...
        <div class="row">
            <div class="col-lg-4">
                <div class="card shadow-sm border-0">
                    <div class="card-body">
                        <h6 class="text-muted mb-2">عدد فواتير الشراء المؤكدة</h6>
            ...
            <div class="col-lg-4">
                <div class="card shadow-sm border-0">
                    <div class="card-body">
                        ...
                        <h3 class="mb-0">{{ number_format($summary['total_purchases'], 2) }}</h3>
                    </div>
                </div>
            </div>
            <div class="col-lg-4">
                <div class="card shadow-sm border-0">
                    <div class="card-body">
                        <h6 class="text-muted mb-2">صافي المشتريات</h6>
                        <h3 class="mb-0">{{ number_format($summary['net_purchases'], 2) }}</h3>
