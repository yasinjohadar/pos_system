            ...
            <div class="users-detail-item" style="margin: 0;">
                ...
                <div class="users-detail-item__content">
                    ...
                    <div class="users-detail-item__value">
                        <span class="users-user-name" style="cursor: default; font-size: 1.125rem;">{{ $supplier->name }}</span>
                        @if ($supplier->phone)
                            <small class="users-muted-text d-block" dir="ltr">{{ $supplier->phone }}</small>
                        @endif
                    </div>
                </div>
                <div class="users-detail-item__content text-end">
                    <span class="users-detail-item__label">إجمالي الذمم المستحقة</span>
                    <div class="users-detail-item__value">
...
@else
    <div class="users-table-card">
        <div class="users-empty" style="padding: 2.5rem 1rem;">
            اختر مورداً واضغط «عرض» — جرّب <strong>مورد أعمار الذمم — تجريبي</strong> بعد تشغيل <code>PurchaseSeeder</code>
        </div>
    </div>
@endif
