        ...
        <div class="container-fluid p-0">
            <div class="users-premium">
                ...
                <div class="users-header">
                    <h5 class="users-page-title">إنشاء دور جديد</h5>
                ...
                <div class="users-form-card">
                    ...
                    <form method="POST" action="{{ route('roles.store') }}" class="users-form-card__body">
                        @csrf
                        ...
                        <div class="users-form-grid">
                            <div class="users-form-group users-form-group--full">
                                ...
                                <input type="text" class="users-form-input @error('name') is-invalid @enderror"
                                    ...
                                    placeholder="مثال: مشرف عام" required>
                                @error('name')
                        ...
                        <div class="users-form-actions">
                            <button type="submit" class="users-btn-submit">
                                <i class="fas fa-check"></i> حفظ الدور
                            </button>
