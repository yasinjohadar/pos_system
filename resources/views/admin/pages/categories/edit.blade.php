        ...
        <div class="container-fluid p-0">
            <div class="users-premium">
                ...
                <div class="users-header">
                    <h5 class="users-page-title">تعديل التصنيف: {{ $category->name }}</h5>
                ...
                <div class="users-form-layout">
                    <aside class="users-form-aside">
                        ...
                        <h6 class="users-form-aside__title">تعديل بيانات التصنيف</h6>
                        <p class="users-form-aside__text">
                            حدّث معلومات التصنيف مع الحفاظ على الارتباط الصحيح بالتصنيف الأب.
                        </p>
                        <ul class="users-form-aside__tips">
                            <li><i class="fas fa-check"></i> تغيير الأب ينقل التصنيف لهيكل آخر</li>
                            <li><i class="fas fa-check"></i> رفع صورة جديدة يستبدل الصورة الحالية</li>
                    ...
                    <div class="users-form-card">
                        ...
                        <form action="{{ route('admin.categories.update', $category) }}" method="POST" enctype="multipart/form-data" class="users-form-card__body">
                            @csrf
                            @method('PUT')
