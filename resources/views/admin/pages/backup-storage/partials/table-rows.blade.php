    ...
    <tr>
        ...
        <td>
            <span class="users-badge users-badge--role">
                {{ BackupStorageConfig::DRIVERS[$config->driver] ?? $config->driver }}
            </span>
        </td>
        <td>
            @if ($config->is_active)
        ...
        <td>
            <div class="users-actions">
                <a href="{{ route('admin.backup-storage.edit', $config->id) }}"
                ...
                <button type="button" class="users-action-btn users-action-btn--view test-storage-btn"
                    data-test-url="{{ route('admin.backup-storage.test', $config->id) }}"
                ...
                <button type="button" class="users-action-btn users-action-btn--delete"
                    ...
                    data-delete-action="{{ route('admin.backup-storage.destroy', $config->id) }}"
