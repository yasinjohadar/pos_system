    ...
    <div class="auth-page">
        ...
        <aside class="brand-panel">
            <div class="brand-content">
                ...
                <h2 class="brand-headline">مرحباً بعودتك</h2>
                <p class="brand-subheadline">سجّل دخولك لإدارة مبيعاتك وفواتيرك وتقاريرك المالية من لوحة تحكم واحدة.</p>
        ...
        <main class="form-panel">
            <div class="form-card">
                ...
                @if (Route::has('register'))
                    <p class="form-footer">
                        ليس لديك حساب؟ <a href="{{ route('register') }}">أنشئ حساباً جديداً</a>
                    </p>
                @endif
            </div>
        </main>
