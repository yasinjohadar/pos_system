(function () {
    ...
    var filtersForm = document.getElementById('warehouses-filters-form');
    var tableBody = document.getElementById('warehouses-table-body');
    var paginationEl = document.getElementById('warehouses-pagination');
    var tableCard = document.getElementById('warehouses-table-card');
    var clearBtn = document.getElementById('warehouses-filters-clear');
    ...
    function initToggleSwitches() {
        document.querySelectorAll('#warehouses-table-body .users-toggle-input').forEach(function (toggle) {
    ...
    function initFilters() {
        ...
        if (paginationEl) {
            paginationEl.addEventListener('click', function (event) {
                ...
                fetchWarehouses(url.searchParams.get('page') || '1');
            });
        }
    }
