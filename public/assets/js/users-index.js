(function () {
    ...
    var filtersForm = document.getElementById('users-filters-form');
    var tableBody = document.getElementById('users-table-body');
    var paginationEl = document.getElementById('users-pagination');
    var tableCard = document.getElementById('users-table-card');
    var clearBtn = document.getElementById('users-filters-clear');
    ...
    function initCopyButtons() {
        document.querySelectorAll('.users-copy-btn').forEach(function (btn) {
    ...
    function initToggleSwitches() {
        document.querySelectorAll('.users-toggle-input').forEach(function (toggle) {
                ...
                fetch(url, {
                    ...
                    .then(function (result) {
                        if (result.data.success) {
                            ...
                            showToast(result.data.message || 'تم تحديث حالة المستخدم بنجاح', 'success');
                        } else {
                            toggle.checked = !isActive;
                            showToast(result.data.message || 'حدث خطأ أثناء تحديث حالة المستخدم', 'error');
                        }
                    })
                    .catch(function () {
                        toggle.checked = !isActive;
